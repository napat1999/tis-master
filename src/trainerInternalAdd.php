          ...
          <div class="box">
            <header>
              ...
              <ol class="breadcrumb">
                ...
                <li class="active">
                  <i class="fas fa-user"></i> เพิ่มวิทยากรภายใน
                </li>
              </ol>
            </header>
            <div class="body">
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group">
                              <input type="text" style="text-transform: uppercase" class="form-control" id="employeeNo" name="employeeNo" value="<?php echo $employeeNo = isset($employeeNo) ? $employeeNo : ''; ?>" <?php if ($employeeNo <> "") {
                                                                                                                                                                                                                        echo "readonly style='background-color : #d1d1d1;'";
                                                                                                                                                                                                                      } ?> required>
                              <span class="input-group-btn">
                                <button type="button" class="btn btn-primary" style="border-radius: 0px 4px 4px 0px !important;" id="getJPM">
                                  <img src="assets/img/jas_logo.png" height="20px"> อ่านข้อมูลอัตโนมัติ
                                </button>
                              </span>
                            </div>
                          </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-2">
                            <input type="text" class="form-control" id="th_initial" name="th_initial" value="<?php echo $th_initial = isset($th_initial) ? $th_initial : ''; ?>" <?php echo "readonly style='background-color : #d1d1d1;'"; ?>required>
                          </div>
                          <div class="col-sm-6" style="padding-left: 0px;">
                            <input type="text" class="form-control" id="thai_name" name="thai_name" value="<?php echo $thai_name = isset($thai_name) ? $thai_name : ''; ?>" <?php echo "readonly style='background-color : #d1d1d1;'"; ?>required>
                          </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <label class="col-md-8">ประวัติการฝึกอบรม</label>
                              <div class="col-md-12">
                                <textarea id="traininfo" class="form-control" name="traininfo" rows="5" cols="80"></textarea>
                              </div>
                            </div>
                          </div>
