...
(function ($) {
    ...
    $.fn.fileinputLocales['th'] = {
        ...
        msgInvalidFileExtension: 'ไม่รองรับไฟล์ "{name}", อนุญาตเฉพาะไฟล์ "{extensions}"',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgImageWidthSmall: 'ความกว้างของ "{name}" ต้องมีอย่างน้อย {size} px.',
        msgImageHeightSmall: 'ความสูงของ "{name}" ต้องมีอย่างน้อย {size} px.',
        msgImageWidthLarge: 'ความกว้างของ "{name}" ต้องไม่เกิน {size} px.',
        msgImageHeightLarge: 'ความสูงของ "{name}" ต้องไม่เกิน {size} px.',
        ...
        fileActionSettings: {
            ...
            indicatorNewTitle: 'รออัปโหลด',
            indicatorSuccessTitle: 'อัพโหลด',
            indicatorErrorTitle: 'มีข้อผิดพลาด',
