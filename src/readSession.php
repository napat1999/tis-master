              ...
              <div class="body">
                ...
                <div class="row">
                    <div class="lg-12">
                        ...
                        echo "CUR URL=".$_SESSION["CurURL"]."<BR>";
                        echo "HTTP_HOST=".$_SERVER['HTTP_HOST']."<BR>";
                        echo "REQUEST_URI=".$_SERVER['REQUEST_URI']."<BR>";
                        echo "isadmin=".$_SESSION["isadmin"]."<BR>";
                        echo "istraininghq=".$_SESSION["istraininghq"]."<BR>";
                        echo "istrainingro=".$_SESSION["istrainingro"]."<BR>";
                        echo "iscoordinator=".$_SESSION["iscoordinator"]."<BR>";
                        ?>
                    </div>
                </div>
              </div>
